...
def iniciar_chatbot():
    print("🤖 SOC Agent (Blue Team) activado. Comandos: 'analizar', 'logs', 'ayuda', 'salir')")
    ...
    while True:
        ...
        if user_input.lower() == "salir":
            ...
            if not logs_actuales:
                print("No tienes logs capturados. Usa el comando 'logs' primero para esnifar la red.")
                continue
            ...
            print("💡 CONSEJO: Tienes 15 segundos para lanzar hacker_agent.py en tu otra terminal")
