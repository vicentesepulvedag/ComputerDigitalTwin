...
report_data = {
    ...
    "target_os": "Windows 7",
    "cvss": "7.05 [HIGH]",
    "description": "Se detectó tráfico SMB entre atacante y víctima.",
    "technical_explanation": "El atacante utilizó el recurso compartido C$.",
    "mitigations": [
        {
            "severity": "ALTA",
            "description": "Deshabilitar SMBv1",
            "command": "dism /online /disable-feature /featurename:SMB1Protocol",
            "note": "Reiniciar después de ejecutar.",
        },
        {
            "severity": "MEDIA",
            "description": "Bloquear puerto 445",
            "command": "netsh advfirewall firewall add rule ...",
            "note": "Validar servicios legítimos.",
        },
    ],
    "logs": """
SMB WRITE REQUEST
